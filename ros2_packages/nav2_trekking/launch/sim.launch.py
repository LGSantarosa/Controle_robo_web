...
def generate_launch_description():
    pkg_nav2_trekking = get_package_share_directory('nav2_trekking')
    ...
    default_robot_sdf = os.path.join(pkg_nav2_trekking, 'urdf', 'sim_robot.sdf')
    urdf_xacro = os.path.join(pkg_nav2_trekking, 'urdf', 'sim_robot.urdf.xacro')
    ...
    twist_mux_cfg = os.path.join(pkg_nav2_trekking, 'config', 'twist_mux.yaml')
    twist_mux = Node(
        package='twist_mux',
    ...
    teleop_ps4_cfg = os.path.join(pkg_nav2_trekking, 'config', 'teleop_ps4.yaml')
