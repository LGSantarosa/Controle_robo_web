...
class UnstuckSupervisor:
    ...
    def _monitoring(self, now, position, rear_gap, front_gap, goal_active,
        ...
        # NB: a ré "goal-coadjuvante" (07-10) foi removida em 07-20 — disparava
        # perto de gente e era perigosa. O disparo aqui é sempre por CENA.
...
def main(args=None):  # pragma: no cover - I/O glue, validado na bancada
    ...
    class UnstuckSupervisorNode(Node):
        def __init__(self):
            ...
            # disparo com dado na mão em vez de teorizar. Flush em timer (flush
            # por linha a 10Hz castiga o SD da Pi).
            d = "controle_web/logs"
            ...
            self._csv.writerow([
                ...
                "nearest", "obstacle_mapped", "near_mapped"])
        ...
        def _tick(self):
            ...
            # CSV: uma linha por tick (t = relógio ROS;
            ...
            self._csv.writerow([
                ...
                int(obstacle_mapped), int(near_mapped)])
